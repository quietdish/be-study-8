...
public class Cls09Main {
	...
	public static void main(String[] args) {
		...
		//Temp09[] tArr = { 10, 20, 30 };
		Temp09[] tArr = { new Temp09(), new Temp09(), new Temp09() };
		Temp09[] tArr1 = { t1, t2, t3 };
		Temp09[] tArr2 = null;
		tArr2 = new Temp09[3];	//<배열> 공간 3개짜리 선언
		//	null null null
		tArr2[1] = new Temp09();	//<객체> 생성 new Temp09() 기본생성자 호출
		//  null Temp09() null
	...
	public static int[] methodC(int[] arr) {
		//arr[1] = 50; 오류 남... arr 이 null 로 넘어오면 널포인터 예외
		...
		//return null; 	//int[] val = null; 안됨?ㅎ.ㅎ
	}
	
	//System.out.println("ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ");왜안됨 ?
	...
	public static Temp09 methodF() {
		...
		tt.num = 99;
		return tt;		// 이거 안썼더니 오류 뜸 ㅋㅋ......
		//return null; // 	Temp09 t = ...
	}
	
	public static Temp09[] methodG() {	// Temp09 t = ...
