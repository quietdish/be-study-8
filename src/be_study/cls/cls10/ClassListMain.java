...
public class ClassListMain {
	...
	public static void main(String[] args) {
		...
		Temp09 t1 = new Temp09();		//import 안떠서 직접씀.. 5줄
		...
		ArrayList<Temp09> tList = new ArrayList<Temp09>();	//import...3
	...
	public static void printList(ArrayList<Temp09> tList) { //티리스트
	...
	public static ArrayList<Temp09> generateList(){
		...
		list = new ArrayList<Temp09>();		// !list is null 오류 난 다음에 추가한 줄...
