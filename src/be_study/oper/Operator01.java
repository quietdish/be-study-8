...
public class Operator01 {
	...
	public static void main(String[] args) {
		...
		// 증감 ++ --	1증가	1감소	처리후 대상 변수의 변경된 값으로 저장됨.
		// ++변수	: 증가 먼저
		// 변수++	: 증가 나중에						<< 요깅~~~~~
		...
		System.out.println( 1 != 2 );		// 1과 2가 다른가? ㅇㅇ true
		...
		//String eventItem = "커피" ;	<--  참이면
		//String eventItem = "생수" ;	<--  거짓이면		
